...
bash $sScriptsDir/UpdateGnumericGraph.sh graph-templates/interaction-scatterplot-template.xml temp.4.csv figure-interaction-scatterplot-EAW+E+AM.xml
bash $sScriptsDir/UpdateGnumericGraph.sh graph-templates/interaction-scatterplot-template.xml temp.5.csv figure-interaction-scatterplot-T.xml
